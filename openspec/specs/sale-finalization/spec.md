...
Operators SHALL finalize non-empty cart with payment method, discounts, and change per RF-053.

#### Scenario: Successful cash sale

- **WHEN** operator finalizes cart with valid payment and change greater than or equal to zero
- **THEN** Sale aggregate is created, stock is decremented, and SaleCompleted event is published
