# trial-registration Specification

## Purpose

Self-service trial tenant onboarding: public registration endpoint, trial period configuration, and expiration policy per legacy business rules.
