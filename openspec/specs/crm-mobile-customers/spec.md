# crm-mobile-customers Specification

## Purpose

Android Compose screens for customer list and quick registration consuming the CRM API, including find-or-create by CPF for PDV workflows.
