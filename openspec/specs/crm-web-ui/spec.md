# crm-web-ui Specification

## Purpose

Vue admin pages for customer and supplier management with PrimeVue DataTable, forms, and RBAC-guarded routes aligned with legacy clientes/fornecedores permissions.
